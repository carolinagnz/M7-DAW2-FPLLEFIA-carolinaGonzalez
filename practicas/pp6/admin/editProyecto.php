...
/**
 * ========================================
 * ARCHIVO: admin/editProyecto.php
...
$page_title = "Editar Proyecto - Admin - " . SITE_NAME;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titulo)) {
        ...
        $imagen_path = $proyecto['imagen_principal'];
        ...
        if (empty($error)) {
            $stmt = $mysqli->prepare(
                "UPDATE proyectos SET titulo = ?, descripcion = ?, imagen_principal = ?, cliente = ?, categoria = ?, tecnologias = ?, url_proyecto = ?, fecha_inicio = ?, fecha_fin = ?, orden_visualizacion = ?, destacado = ?, activo = ? WHERE id = ?"
            );
            
            if ($stmt) {
                $stmt->bind_param("sssssssssiiil", $titulo, $descripcion, $imagen_path, $cliente, $categoria, $tecnologias, $url_proyecto, $fecha_inicio, $fecha_fin, $orden_visualizacion, $destacado, $activo, $proyecto_id);
                
                if ($stmt->execute()) {
                    header("Location: proyectos.php?success=updated");
                    exit();
                } else {
                    $error = "Error al actualizar proyecto: " . $stmt->error;
                }
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="text-white font-weight-bold">
                    <i class="ti-pencil"></i> Editar Proyecto
                </h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="categoria" class="form-control">
                                            ...
                                            <option value="Web Development" <?php echo $proyecto['categoria'] == 'Web Development' ? 'selected' : ''; ?>>Web Development</option>
                                            <option value="Mobile App" <?php echo $proyecto['categoria'] == 'Mobile App' ? 'selected' : ''; ?>>Mobile App</option>
                                            <option value="E-commerce" <?php echo $proyecto['categoria'] == 'E-commerce' ? 'selected' : ''; ?>>E-commerce</option>
                                            <option value="Software" <?php echo $proyecto['categoria'] == 'Software' ? 'selected' : ''; ?>>Software</option>
                                            <option value="Design" <?php echo $proyecto['categoria'] == 'Design' ? 'selected' : ''; ?>>Design</option>
                                            <option value="Branding" <?php echo $proyecto['categoria'] == 'Branding' ? 'selected' : ''; ?>>Branding</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="descripcion" class="form-control" rows="8" required><?php echo htmlspecialchars($proyecto['descripcion']); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tecnologias" class="form-control"
                                               ...
                                               value="<?php echo htmlspecialchars($proyecto['tecnologias']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="url_proyecto" class="form-control"
                                               ...
                                               value="<?php echo htmlspecialchars($proyecto['url_proyecto']); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha_inicio" class="form-control"
                                               value="<?php echo htmlspecialchars($proyecto['fecha_inicio']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha_fin" class="form-control"
                                               value="<?php echo htmlspecialchars($proyecto['fecha_fin']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="orden_visualizacion" class="form-control" min="0"
                                               value="<?php echo htmlspecialchars($proyecto['orden_visualizacion']); ?>">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label><i class="ti-image"></i> Cambiar Imagen Principal</label>
